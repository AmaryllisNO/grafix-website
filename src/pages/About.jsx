      ...
      <div className='about__container wrapper'>
        <div className='about__text'>
          <p className='about__paragraph'>
            ...
            half of ‘Fred V & Grafix’, Josh Jackson has been at the forefront of
            the genre for over a decade with a trio of collaborative albums
            under his belt. Now after years of success, he’s taken a new
            direction embracing his revived identity as a solo artist.{' '}
          </p>
          <p className='about__paragraph'>
            Widely respected for his clinical mixdowns and impeccable production
            skills, this sharp musical brain is poised for great things as he
          ...
          <p className='about__paragraph'>
            ...
            development and exploration of his style has seen appreciation from
            dance music connoisseurs including Andy C, Metrik, A.M.C and High
            Contrast. With his inspirations drawing from techno to indie rock,
            Grafix’s remarkable production skill and originality has seen him
            garner radio support from airwave tastemakers in 2020 such as Rene
            LaVice, Danny Howard, Charlie Tee, and Mollie Collins, and even a
            collaboration with fellow label extraordinaire Metrik on ‘Parallel’.
          </p>
        </div>
